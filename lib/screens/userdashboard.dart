...
class _UserDashboardState extends State<UserDashboard> {
  ...
  void initState(){
    ...
    FirebaseFirestore.instance
        ...
        .get()
        .then((value) {
      this.loggedInUser = UserModel.fromMap(value.data()); //https://dart-lang.github.io/linter/lints/unnecessary_this.html
      setState(() {});
    });
  }
  ...
  Future<void> SignOut(BuildContext context) async {
    ...
    Navigator.of(context).pushReplacement( //have to change to avoid using BuildContexts across async gaps
